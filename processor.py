    ...
    def elaborate(self, platform):
        ...
        with m.Switch(ID_instruction[26:32]):
            ...
            with m.Case(0b000000):
                m.d.pos += ID_RegDst.eq(1)
                m.d.pos += ID_ALUSrc.eq(0)
                m.d.pos += ID_Memto_Reg.eq(0)
                m.d.pos += ID_Reg_Write.eq(1)
                m.d.pos += ID_Mem_Read.eq(0)
                m.d.pos += ID_Mem_Write.eq(0)
                m.d.pos += ID_Branch.eq(0)
                m.d.pos += ID_ALUOP.eq(0b010)
            # lw
            with m.Case(0b100011):
                m.d.pos += ID_RegDst.eq(0)
                m.d.pos += ID_ALUSrc.eq(1)
                m.d.pos += ID_Memto_Reg.eq(1)
                m.d.pos += ID_Reg_Write.eq(1)
                m.d.pos += ID_Mem_Read.eq(1)
                m.d.pos += ID_Mem_Write.eq(0)
                m.d.pos += ID_Branch.eq(0)
                m.d.pos += ID_ALUOP.eq(0b000)
            # sw
            with m.Case(0b101011):
                m.d.pos += ID_RegDst.eq(0)
                m.d.pos += ID_ALUSrc.eq(1)
                m.d.pos += ID_Memto_Reg.eq(0)
                m.d.pos += ID_Reg_Write.eq(0)
                m.d.pos += ID_Mem_Read.eq(0)
                m.d.pos += ID_Mem_Write.eq(1)
                m.d.pos += ID_Branch.eq(0)
                m.d.pos += ID_ALUOP.eq(0b000)
            # beq
            with m.Case(0b000100):
                ...
                m.d.pos += ID_Mem_Read.eq(0)
                m.d.pos += ID_Mem_Write.eq(0)
                m.d.pos += ID_Branch.eq(1)
                m.d.pos += ID_ALUOP.eq(0b001)
            # addi
            ...
            with m.Default():
                ...
                m.d.pos += ID_Mem_Write.eq(0)
                m.d.pos += ID_Branch.eq(0)
                m.d.pos += ID_ALUOP.eq(0b111) # numero que no se usa   
        ...
        m.d.comb += AddResultI.eq(EX_PC_4 + (Cat(0b00,EX_immediate[0:30])))
