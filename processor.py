...
class PROCESSOR(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.d.comb+= self.RdStb.eq(1)
        m.d.comb+= self.Wrstb.eq(0)
        ...
        with m.If(self.Reset):
            m.d.comb += ID_instruction.eq(0)
            m.d.comb += ID_PC_4.eq(0)
        with m.d.Else():
        ...
        with m.If(ID_instruction[15]== 0):
            m.d.comb += ID_sig_ext.eq(0x0000 & ID_instruction[0:16])
        ...
        with m.If(self.Reset):
            m.d.comb += EX_RegA.eq(0x00000000)
            m.d.comb += EX_RegB.eq(0x00000000) 
            m.d.comb += EX_RegD_LW.eq(00000)
            m.d.comb += EX_RegD_TR.eq(00000)
            m.d.comb += EX_PC_4.eq(0x00000000)
            m.d.comb += EX_immediate.eq(0x00000000)  
            m.d.comb += EX_Ctrl_RegDst.eq(0)
            m.d.comb += EX_Ctrl_ALUSrc.eq(0)
            m.d.comb += EX_Ctrl_Memto_Reg.eq(0)
            m.d.comb += EX_Ctrl_Reg_Write.eq(0)
            m.d.comb += EX_Ctrl_Mem_Read.eq(0)
            m.d.comb += EX_Ctrl_Mem_Write.eq(0)
            m.d.comb += EX_Ctrl_Branch.eq(0)
            m.d.comb += EX_Ctrl_ALUOP.eq(000)
            ...
            m.d.pos += EX_immediate.eq(ID_sig_ext)
        ...
        m.d.comb += AddResultI.eq(EX_PC_4 + (EX_immediate[0:30].shift_left(2)))
        ...
        with m.If(self.Reset):
            m.d.comb += MEM_PC_Branch.eq(0x00000000)
            m.d.comb += MEM_RegDst.eq(00000)
            ...
            m.d.comb += MEM_RegB.eq(0x00000000)
            m.d.comb += MEM_ALU_Result.eq(0x00000000)
        ...
        m.b.comb += self.D_Addr.eq(MEM_ALU_Result)
        m.b.comb += self.RdStb.eq(MEM_Ctrl_Mem_Read)
        m.b.comb += self.Wrstb.eq(MEM_Ctrl_Mem_Write)
        m.b.comb += self.D_DataOut.eq(MEM_RegB)
        m.b.comb += D_DataALUIn.eq(self.D_DataIn)
        ...
        with m.If(self.Reset):
            m.b.comb += WB_Ctrl_Memto_Reg.eq(0)
            m.b.comb += WB_RegDst.eq(00000)
            m.b.comb += WB_Reg_Write.eq(0)
            m.b.comb += WB_ALU_Result.eq(0x00000000)
            m.b.comb += WB_Read_Data.eq(0x00000000)
            
        m.b.pos += WB_Ctrl_Memto_Reg.eq(MEM_Ctrl_Memto_Reg)
        m.b.pos += WB_RegDst.eq(MEM_RegDst)
        m.b.pos += WB_Reg_Write.eq(MEM_Ctrl_Reg_Write)
        m.b.pos += WB_ALU_Result.eq(MEM_ALU_Result)
        m.b.pos += WB_Read_Data.eq(D_DataALUIn)
        
        # Inicio etapa WB

        with m.If(WB_Ctrl_Memto_Reg):
            m.b.comb += WB_data_wr.eq(WB_Read_Data)
        with m.Else():
            m.b.comb += WB_data_wr.eq(WB_ALU_Result)
